...
# ---------------------------------------------------------------------------
# Note: caching is handled at the PolygonClient layer via @cached decorators
# on individual API methods. The data pipeline functions are pure wrappers
# that compose client calls — caching here would duplicate effort and fail
# to serialize client instances in JSON cache keys.
